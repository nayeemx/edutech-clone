        ...
        <>
            ...
            <section className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {getFilteredTasks().map((task) => (
                    <div
                        key={task.id}
                        className="bg-white rounded-lg shadow-md p-2 cursor-pointer flex flex-col justify-between"
                        ...
                        <div className="flex items-center justify-between w-full mt-4 pt-2 border-t-2">
                            ...
                            <div>
                                <button
                                    ...
                                    className="text-red-500 hover:text-red-700 relative top-[1vh]"
                                >
                                    <BsTrash size={20} />
                                </button>
                            </div>
                            ...
                            <div>
                                <button
                                    ...
                                    className="text-gray-700 hover:text-gray-900 relative top-[0.7vh]"
                                >
                                    <IoColorPaletteSharp />
                                </button>
                                {openColorDropdownId === task.id && (
                                    <div className="absolute mt-1 bg-white border rounded shadow z-10 w-[8.2vw] h-[24vh]">
                                        {[
