...
import Tasks from "./Tasks"; // Import new component
...
const ToDo = () => {
        ...
        const unsubscribe = auth.onAuthStateChanged((user) => {
            if (user) {
                ...
                db.ref(`users/${userId}`).once("value")
                    ...
                    .catch(() => {
                        // 3. Fallback to auth data if database fails
    ...
    const handleDelete = async (taskId) => {
        ...
        await db.ref(`tasks/${auth.currentUser.uid}/${taskId}`).remove();
    };
                        ...
                        {taskList.map((t, i) => (
                            <div key={i} className="flex items-center mb-2 gap-2">
                                ...
                                <input
                                    ...
                                    className={`border p-2 rounded w-full ${t.isSubtask ? "ml-8" : ""
                                        }`}
                                />
                                <input
                                    type="checkbox"
